...
日期：2026-05-25  
状态：已整理为 v3.3 精简决策系统。旧报告没有删除，已移入归档。

## 快速入口

当前默认使用：

- `00_active_system/optimization_plan_v3_3.md`：v3.3 优化方案。
- `00_active_system/lean_decision_system_v1.md`：默认精简决策规则。
- `00_active_system/prospective_event_ledger_v1.csv`：前瞻事件账本。
...
3. 每个新事件先写入 `prospective_event_ledger_v1.csv`，再做事后复盘。
4. 旧文件保留在 `99_archive_superseded/`，需要时可以恢复。
